...
optionsStruct options::Options{
    {
        {"Left Flipper key",
         ...
         {InputTypes::Keyboard, DUMMY_KEY},
         {InputTypes::Mouse, DUMMY_KEY},
         {InputTypes::GameController, BUTTON_L}},
        {"Right Flipper key",
         Msg::KEYMAPPER_FlipperR,
         {InputTypes::Keyboard, DUMMY_KEY},
         {InputTypes::Mouse, DUMMY_KEY},
         {InputTypes::GameController, BUTTON_R}},
        {"Plunger key",
         Msg::KEYMAPPER_Plunger,
         {InputTypes::Keyboard, DUMMY_KEY},
         {InputTypes::Mouse, DUMMY_KEY},
         {InputTypes::GameController, BUTTON_A}},
        {"Left Table Bump key",
         Msg::KEYMAPPER_BumpLeft,
         {InputTypes::Keyboard, DUMMY_KEY},
         {InputTypes::Mouse, DUMMY_KEY},
         {InputTypes::GameController, BUTTON_PAD_LEFT}},
        {"Right Table Bump key",
         Msg::KEYMAPPER_BumpRight,
         {InputTypes::Keyboard, DUMMY_KEY},
         {InputTypes::Mouse, DUMMY_KEY},
         {InputTypes::GameController, BUTTON_PAD_RIGHT}},
        {"Bottom Table Bump key",
         Msg::KEYMAPPER_BumpBottom,
         {InputTypes::Keyboard, DUMMY_KEY},
         {InputTypes::Mouse, DUMMY_KEY},
         {InputTypes::GameController, BUTTON_PAD_DOWN}},
        {"New Game",
         Msg::Menu1_New_Game,
         {InputTypes::Keyboard, DUMMY_KEY},
         {},
         {InputTypes::GameController, BUTTON_Z}},
        {"Toggle Pause",
         Msg::Menu1_Pause_Resume_Game,
         {InputTypes::Keyboard, DUMMY_KEY},
         {},
         {InputTypes::GameController, BUTTON_START}},
        {"Toggle FullScreen",
        ...
        {"Exit",
         ...
         {InputTypes::Keyboard, DUMMY_KEY},
         {},
         {InputTypes::GameController, DUMMY_KEY}},
    },
    {"Sounds", true},
    {"Music", false},
    {"FullScreen", false},
