...
#define BUTTON_PAD_UP 0x0800
#define BUTTON_PAD_DOWN 0x0400
#define BUTTON_PAD_LEFT 0x0200
#define BUTTON_PAD_RIGHT 0x0100
...
public:
    ...
    static constexpr int MaxVolume = 128, MinVolume = 0, DefVolume = 64;
...
struct ControlOption : OptionBase
{
    ...
    ControlOption(LPCSTR name, Msg description, GameInput defaultKeyboard, GameInput defaultMouse,
                  GameInput defaultController) : OptionBase(name),
