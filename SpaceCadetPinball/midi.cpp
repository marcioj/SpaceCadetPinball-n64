...
std::vector<xm64player_t *> midi::LoadedTracks{};
xm64player_t *midi::track1, *midi::track2, *midi::track3;
MidiTracks midi::active_track, midi::NextTrack;
int midi::Volume = 1.0f;
...
xm64player_t *midi::load_track(std::string fileName)
{
...
xm64player_t *midi::TrackToMidi(MidiTracks track)
{
    xm64player_t *midi;
    switch (track)
    {
