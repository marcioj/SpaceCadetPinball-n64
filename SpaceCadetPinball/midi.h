...
private:
    static std::vector<xm64player_t *> LoadedTracks;
    static xm64player_t *track1, *track2, *track3;
    static MidiTracks active_track, NextTrack;
    static int Volume;
    static bool IsPlaying, MixOpen;

    static void StopPlayback();
    static xm64player_t *load_track(std::string fileName);
    static xm64player_t *load_track_sub(std::string fileName, bool isMidi);
    static xm64player_t *TrackToMidi(MidiTracks track);
